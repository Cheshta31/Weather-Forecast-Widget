...
const WeatherCard = ( {temperature , windspeed, humidity , place,feelsLike ,iconString,conditions}) => {
    ...
    return (
        <div className="w-[22rem] min-w-[22rem] h-[30rem] glassCard px-4">
            ...
            <div className="w-full flex justify-between items-center mt-4 gap-4">
                ...
                <p className="flex-1 text-center p-2 font-bold bg-green-600 rounded-lg"> Humidity
                    <p className="font-normal">
                        {humidity} gm/m<sup>3</sup>
                    </p>
                </p>
            </div>
            <div className="w-full p-3 mt-4 flex justify-between items-center">
                <p className="font-semibold text-lg"> Feels Like</p>
                <p className="text-lg"> {feelsLike ? feelsLike : 'N/A'} &deg;C</p>
            </div>
